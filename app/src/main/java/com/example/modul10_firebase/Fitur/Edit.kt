package com.example.modul10_firebase.Fitur
...
import com.example.modul10_firebase.R
...
//              //Update the data in Firebase
                    ...
                    database.child(nim).updateChildren(updatedData).addOnSuccessListener {
                        ...
                        .addOnFailureListener { Toast.makeText(this@Edit, "Failed to update data", Toast.LENGTH_SHORT).show()
                        }
                } else {
